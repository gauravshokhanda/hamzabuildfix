...
const Privacy = () => {
    return (
        <div className="pb-16">
            {/* Header Section */}
            <div className="w-full bg-primary p-8 md:p-16 lg:p-32 text-center">
            ...
            <div className="w-full flex flex-col items-center bg-gray-50 py-20">
                ...
                <div className="max-w-[1140px] w-full space-y-10 text-left px-10 md:px-12 lg:px-32">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-black mb-4">Managing Your Information</h2>
                        <p className="text-gray-700 leading-relaxed">
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a
                            type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining
                    ...
                    {/* Security Section */}
                    <section>
                        <h2 className="text-2xl font-semibold text-black mb-4">Security</h2>
                        <p className="text-gray-700 leading-relaxed">
