  ...
  return (
    <section className="bg-background_blue py-12 px-4 md:px-12">
      <div className="container mx-auto text-center">
        ...
        <Heading
          title="Why Tutor with"
          spanned="Tafawwaq?"
          center={true}
          subtitle="Discover the benefits that make tutoring with us truly rewarding."
        />
        {/* Icon grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-8">
          <Card
            Heading="Flexible Scheduling"
            content="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cursus nibh mauris,"
            icon={flex_sch}
          />
          <Card
          ...
          />
          <Card
            Heading="Access to a Broad Client Base"
            content="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cursus nibh mauris,"
            icon={access_cb}
          />
          <Card
