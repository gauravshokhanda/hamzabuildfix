  ...
  return (
    <>
      ...
      <div className="grid grid-cols-12 gap-6 mb-8">
        <div className="bg-white col-span-3 rounded-2xl shadow-md p-4">
      ...
      <div className="grid grid-rows-2 gap-6">
        {/* First Row: Subject Statistics and Peak Hours */}
        ...
        {/* Second Row: Average Session Duration and Rating */}
        <div className="grid grid-cols-[2fr_1fr] gap-6">
          {/* Average Session Duration */}
          <div className="bg-white rounded-2xl shadow-xl p-6 h-[280px]">
            {" "}
            {/* Fixed height */}
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-gray-700 font-medium">
          ...
          {/* Rating Card */}
          <div className="bg-white rounded-2xl shadow-xl p-6 h-[280px] flex items-center">
            {" "}
            {/* Fixed height */}
            <div>
              <div className="mb-4">
                <GraduationCap
                  className="text-[#42ABD1] font-light"
                  size={60}
                />
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="text-md text-[#1C1D1D] font-medium mb-1">
                  4.8
                </div>
              </div>
