      ...
      <div className="relative flex flex-col lg:flex-row items-center lg:items-center justify-between bg-white py-16 px-6 lg:px-16 max-w-7xl mx-auto">
        ...
        <div className="lg:w-1/2 flex flex-col py-6  px-5 md:px-24 space-y-6 lg:self-center">
          ...
          <ul className="text-gray-600 space-y-4">
            <li className="flex items-start space-x-2">
              ...
              <p>
                <strong>Dedicated Support Team:</strong> Available to assist with any queries or issues.
              </p>
            </li>
            <li className="flex items-start space-x-2">
              <span className="text-secondary font-bold">•</span>
              <p>
                <strong>Prompt Service:</strong> Ensuring a smooth experience with reliable customer service.
              </p>
            </li>
          </ul>
        ...
        <div className="relative lg:w-1/2 mt-10 lg:mt-0 z-10 flex justify-center items-center">
          ...
          <div className="absolute top-[-20px] right-[-20px] md:top-[-10px] md:right-[10px] lg:right-[57px]">
            <Image src={rightTopShape} alt="Top Decorative Shape" width={60} height={60} />
          </div>
          <div className="absolute bottom-[-20px] left-[-20px] md:bottom-[-10px] md:left-[10px] lg:bottom-[-30px] lg:left-[50px]">
            <Image src={leftBottomShape} alt="Bottom Decorative Shape" width={60} height={60} />
          </div>
          <div className="absolute top-1/2 right-[10%] z-0 md:right-[5%] lg:right-[10%]">
            <Image src={ellipseShape} alt="Ellipse Decorative Shape" width={80} height={80} className="z-0" />
          </div>
        </div>
