                ...
                <div className="flex py-2 justify-between items-center">
                    ...
                    <div className="hidden md:block lg:pl-14">
                        <div className="ml-6 flex items-baseline space space-x-4 lg:space-x-6">
                            ...
                            <Dropdown label="Become a tutor" items={[
                    ...
                    <div className="hidden md:block">
                        <div className="flex items-center md:ml-6 space-x-4">
                            <div className='w-36'>
                                <button className='rounded-full py-3 border-2 border-white bg-secondary w-full h-full text-white font-semibold text-md'>Login</button>
                            </div>
                    ...
                    <div ref={menuRef} className="-mr-2 flex md:hidden">
                        <button onClick={toggleMenu} className="text-gray-500 inline-flex items-center justify-center p-2 rounded-md focus:outline-none">
